...
const page = () => {
  return (
    <>
      ...
      <div className="flex flex-col lg:flex-row items-center lg:items-start pl-4 lg:pl-20 mt-10 lg:mt-40 space-y-6 lg:space-y-0">
      <div className="flex-shrink-0">
        <Image src="/girl.png" alt="girl" width={400} height={400} />
      </div>
      <div className="lg:ml-20 mt-10 lg:mt-20">
        <h1 className="text-2xl lg:text-4xl font-bold">Buyer’s Feedback</h1>
